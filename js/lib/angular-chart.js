(function (factory) {
  ...
  return angular.module('chart.js', [])
    ...
    .directive('LineAlt', ['ChartJsFactory', function (ChartJsFactory) { return new ChartJsFactory('LineAlt'); }])
    .directive('BarAlt', ['ChartJsFactory', function (ChartJsFactory) { return new ChartJsFactory('BarAlt'); }]);
