    ...
    //-- DOM methods
        ...
        retinaScale = helpers.retinaScale = function(chart){
            var ctx = chart.ctx,
                ...
                height = chart.canvas.width;

            if(ctx.canvas.className.indexOf("chart-doughnut") > -1){

                ctx.canvas.style.width = width + "px";
                ctx.canvas.style.height = (width + 10) + "px";

                if (window.devicePixelRatio) {
                    ctx.canvas.style.width = width + "px";
                    ctx.canvas.style.height = (width + 10) + "px";
                    ctx.canvas.height = (width + 10) * window.devicePixelRatio;
